  ...
  <div style={{}}>
    {'Center me inside the image'}
      ...
      >
        ...
        />
        <Radio type="hidden" name="Answer" value="wrong" onChange={handleChange} />
                <Radio type="hidden name="Answer" value="close" onChange={handleChange} />
                <Radio type="hidden name="Answer" value="correct" onChange={handleChange} />
        {isSolutionVisible && (
          <>
            <br />
            <h3>Solution:</h3>
