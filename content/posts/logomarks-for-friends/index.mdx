...
import { Image, Flex, Box, Grid, Link } from "theme-ui"
...
<Image src="./assets/moonhighway@2x.gif" width="240px" alt="moonhighway.com" />
...
Joel Hooks is a co-founder of [egghead.io](https://egghead.io). Go check out his [Digital Garden](https://joelhooks.com) and [follow Joel on Twitter](https://twitter.com/jhooks).

<Grid sx={{py: 5, alignItems: 'center', justifyContent: 'center', border: '1px solid #f1f1f1', mb: 4}}>

<Img src="./assets/joel2.svg" alt="joelhooks.com" />

</Grid>

## [Epic React](https://epicreact.dev/) by Kent C. Dodds

<Grid columns={[1, 2]} gap={2} mb={4}>
...
<Box
  sx={{
    py: 3,
    border: "1px solid #f1f1f1",
    img: {width: '200px', height: 'auto', m: 0}, p: {m: 0},
    '.gatsby-resp-image-wrapper': {
      width: 245
    }
}}>

<Image src="./assets/epicreact@2x.png" alt="epicreact.dev" />
...
<Grid
  columns={[1, 2]}
  sx={{  alignItems: "center", justifyContent: 'center', '.gatsby-resp-image-wrapper': {
    width: 130
  } }}
>
...
<Image src="./assets/6d@2x.gif" width="300px" alt="6D Academy" />
